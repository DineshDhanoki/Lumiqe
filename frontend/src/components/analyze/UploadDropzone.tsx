            ...
            <div
                ...
                className={cn(
                    ...
                    isDragging
                        ...
                        : 'border-outline-variant/30 bg-surface-container/30 backdrop-blur-md'
                )}
            ...
            >
                <div className="flex flex-col items-center gap-6 p-8 w-full justify-center">
                    ...
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-sm text-on-surface-variant">{t(lang, 'dragDrop')}</p>
                        <p className="text-xs text-on-surface-variant/50">{t(lang, 'maxSize')}</p>
                    </div>
                    <input
                        type="file"
                        accept="image/*"
