        ...
        >
            ...
            <div className="bg-surface-container/50 border border-primary/10 rounded-3xl p-6">
                <div className="relative">
                    {/* Vertical line */}
                    {points.length > 1 && (
                        <div className="absolute left-[19px] top-6 bottom-6 w-px bg-primary/10" />
                    )}
                    ...
                    <div className="space-y-6">
                        {points.slice(0, 10).map((point, i) => (
                            ...
                            >
                                ...
                                <div
                                    className="w-10 h-10 rounded-xl border-2 border-outline-variant/30 flex-shrink-0 group-hover:scale-110 transition-transform z-10"
                                    style={{ backgroundColor: point.hex_color }}
                                />
                                <div className="flex-1 min-w-0">
                                    <p className="text-on-surface font-semibold text-sm truncate group-hover:text-primary transition-colors">
                                        {point.season}
                                        {i === 0 && <span className="ml-2 text-xs text-primary font-normal">Latest</span>}
                                    </p>
