...
export default function ShoppingAgentError({ error, reset }: ErrorProps) {
    return (
            ...
            <div className="max-w-md w-full text-center space-y-6">
                ...
                <div className="space-y-2">
                    <h1 className="text-2xl font-bold text-on-surface">
                        Shopping Agent Encountered an Error
                    </h1>
                    <p className="text-on-surface-variant text-sm">
                        {error.message || 'The shopping agent ran into a problem. Please try again in a moment.'}
                    </p>
                </div>
