    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-6">
            <div className="max-w-md text-center space-y-6">
                ...
                <h1 className="text-2xl font-bold text-on-surface">Dashboard Error</h1>
                <p className="text-on-surface-variant">{error.message || 'Something went wrong loading your dashboard.'}</p>
