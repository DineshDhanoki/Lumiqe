            ...
            <div className="max-w-md w-full bg-zinc-900/60 border border-white/10 rounded-2xl p-8 space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                                minLength={8}
                                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 pr-12"
                    ...
                    <button
                        ...
                        className="w-full py-3 bg-red-600 rounded-full text-white font-medium hover:bg-red-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
