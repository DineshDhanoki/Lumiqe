"""
Alembic env.py — Async PostgreSQL migration runner for Lumiqe.

Connects to the database using the async engine and runs migrations
against the models defined in models.py.
"""
